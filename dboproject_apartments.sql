...
CREATE TABLE `apartments` (
  ...
  CONSTRAINT `apartments_ibfk_1` FOREIGN KEY (`apartmentID`) REFERENCES `property` (`propertyID`)
...
INSERT INTO `apartments` VALUES (102,2,1140,'furnished'),(103,4,2000,'semiFurnished');
